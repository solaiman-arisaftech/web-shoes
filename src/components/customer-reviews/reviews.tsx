...
const Reviews = () => {
  return (
    <section className="w-full flex flex-col my-16 px-64 gap-8" id="reviews">
      <div className="flex self-center text-black text-center text-5xl font-semibold gap-4 py-10">
