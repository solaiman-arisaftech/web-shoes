...
const About = () => {
  return (
    <div className="w-full flex flex-col my-16 px-4 md:px-32 gap-8">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4 w-full">
        ...
        <div className="flex w-full md:w-2/5 gap-6 p-4 text-sm text-justify border-purple rounded-xl border-2 shadow-md shadow-purple">
      ...
      <div className="self-center">
        <button className="border-NeonPink border-1 hover:bg-NeonPink hover:text-white px-2 py-1 shadow-md shadow-NeonPink font-semibold hover:duration-300 ">Shop Now</button>
      </div>
    </div>
  );
};
