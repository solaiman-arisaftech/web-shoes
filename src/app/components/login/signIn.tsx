...
const SignIn = () => {
  return (
    <section className=" bg-login-bg bg-cover bg-center w-full md:min-h-screen flex justify-between mx-64 px-4 md:px-16 lg:px-32 xl:px-64 py-36  md:py-36 gap-4" id="login">
